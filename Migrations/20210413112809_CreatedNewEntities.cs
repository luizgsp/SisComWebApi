    ...
    public partial class CreatedNewEntities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                table: "Phones",
                newName: "IX_Phones_SupplierId");

            migrationBuilder.RenameIndex(
                name: "IX_BankAccount_SupplierId",
                table: "BankAccounts",
                newName: "IX_BankAccounts_SupplierId");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MunicipalRegistration = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    Contact = table.Column<string>(type: "nvarchar(55)", maxLength: 55, nullable: true),
                    ...
                    BuyLimit = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Partners_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Partners_Suppliers_SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Document_Partners_PartnerId",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                table: "Phone",
                newName: "IX_Phone_SupplierId");

            migrationBuilder.RenameIndex(
                name: "IX_BankAccounts_SupplierId",
                table: "BankAccount",
                newName: "IX_BankAccount_SupplierId");
